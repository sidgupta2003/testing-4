...
SECRET_KEY = 'django-insecure-lsp*d0s51r__$=)(q*lt^*g#iea)@^93(kd)#*$@phtp**&@a+'
...
ENVIRONMENT = os.getenv('DJANGO_ENV', 'local')  # Default is 'local'
...
DATABASES = {
    ...
    #     'USER': 'root',
    #     'PASSWORD': '',
    #     'HOST': 'localhost',  # Use the database server address if remote
